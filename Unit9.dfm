object Form9: TForm9
  ...
  Caption = #1056#1077#1081#1089' '#1052#1080#1085#1089#1082'-'#1052#1086#1083#1086#1076#1077#1095#1085#1086' ; '#1056#1072#1089#1087#1080#1089#1072#1085#1080#1077' '#1101#1083#1077#1082#1090#1088#1080#1095#1077#1082
  ClientHeight = 460
  ClientWidth = 553
  Color = clBtnFace
  ...
  object qry1: TADOQuery
    ...
    CursorType = ctStatic
    Filter = 'reic like %'#1052#1080#1085#1089#1082'-% and racpisanie like %'#1088#1072#1089'%'
    Filtered = True
    Parameters = <>
    SQL.Strings = (
